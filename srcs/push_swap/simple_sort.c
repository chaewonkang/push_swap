...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/11 17:52:53 by ckang             #+#    #+#             */
/*   Updated: 2021/07/06 17:22:42 by ckang            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void sort_a(t_stack *e)
{
	...
	else if (((e->stack_a[0] != e->max && e->stack_a[0] > e->stack_a[1]) || (e->stack_a[0] == e->min && e->stack_a[1] == e->max)) && (op = SA))
		do_op(e, SA);
	else if ((op = RA))
		do_op(e, RA);
	if (op)
